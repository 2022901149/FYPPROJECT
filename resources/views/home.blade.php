...
<section class="home" id="home">
    ...
    <div class="content" data-aos="fade-down">
        <h3>Welcome {{auth()->user()->name}} ! Two Rings - Where Dreams Begin and Love Blooms!</h3>
...
<section class="about" id="about">
    ...
    <div class="row">
        ...
        <div class="content" data-aos="fade-up" data-aos-delay="150">
            <h3>Welcome</h3>
            <p>Discover the joy of seamless wedding planning with Two Rings Wedding Planner. We understand that your wedding day is a celebration of love, and we're here to make it extraordinary.</p>
            <p>Our team of dedicated planners is committed to creating magical moments while keeping your budget in mind. Whether you dream of a grand celebration or an intimate gathering, we have the perfect plan for you.</p>
 ...
 <section class="services" id="services">
    ...
    <div class="box-container">
        ...
        <div class="box" data-aos="zoom-in" data-aos-delay="150">
          <img src="images/allocate.png" alt="">
          <h3>Budget calculator</h3>
          <p>Tell us your budget, and our system will allocate funds strategically to ensure each aspect of your wedding gets the attention it deserves.</p>
        </div>
 
       <div class="box" data-aos="zoom-in" data-aos-delay="300">
          <img src="images/suggest.png" alt="">
          <h3>Planning with Recommendations</h3>
          <p>Experience effortless wedding planning with our recommendations, ensuring every detail aligns with your allocated budget.</p>
       </div>
 
       <div class="box" data-aos="zoom-in" data-aos-delay="450">
          <img src="images/deadline.png" alt="">
          <h3>Wedding Checklist</h3>
          <p>Create and personalize wedding tasks with ease. Prioritize and track progress to stay organized throughout your planning journey. </p>
       </div>
