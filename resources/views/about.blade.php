...
<header class="header">
    ...
    <nav class="navbar">
       <a data-aos="zoom-in-left" data-aos-delay="300" href="landing">home</a>
...
<section class="about" id="about">
    ...
    <div class="row">
        ...
        <div class="content" data-aos="fade-up" data-aos-delay="150">
            ...
            <p>At <i>Two Rings Wedding Planner</i>, we understand that every love story is unique, and so is every dream wedding. We are a passionate team dedicated to simplifying the wedding planning journey and turning your dreams into reality.</p>
            
            <div class="section-container">
                <h3>Our Mission</h3>
                <p>Our mission is to empower couples with a personalized and budget-friendly wedding experience.</p>
            </div>
        
            <div class="section-container">
                <h3>Our Vision</h3>
                <p>We envision a world where wedding planning is a joyous and stress-free experience for every couple. By harnessing the power of technology, we aim to revolutionize the way weddings are planned, making it accessible to all.</p>
            </div>
    ...
    <div class="row">
        ...
        <div class="content">
            ...
            <p>Personalized Recommendations: Our system goes beyond the ordinary, utilizing cutting-edge algorithms to understand your vision and preferences. Your dream wedding starts with a simple input – your budget.</p>
            <br>
            <p>Budget-Friendly Excellence: We believe that a tight budget shouldn't mean compromising on quality. Our system intelligently calculates and recommends services that align with your financial plan, ensuring a spectacular celebration within your means.</p>
            <br>
            <p>Simplified Planning: No more overwhelming choices. We streamline the planning process, presenting you with tailored recommendations that suit your budget.</p>
         
            <hr>
            <p>Join us at <i>Two Rings Wedding Planner</i> as we embark on this journey to redefine wedding planning. Your story is unique, and so should be your wedding. Let us be your companion in creating moments that last a lifetime.</p>
        </div>
